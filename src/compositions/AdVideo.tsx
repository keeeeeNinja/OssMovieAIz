...
// ===== クリップ定義 =====
const clips = [
  { file: "scene01_hook_wan21.mp4", durationInFrames: 60, main: "これめっちゃわかる", sub: null },
  { file: "scene02_mirror_wan21.mp4", durationInFrames: 45, main: "すっぴん？って聞かれる", sub: null },
  { file: "scene03_mask_wan21.mp4", durationInFrames: 45, main: "存在感ゼロ", sub: null },
  { file: "scene04_selfie_wan21.mp4", durationInFrames: 45, main: "目が埋もれる", sub: null },
  { file: "scene05_compare_wan21.mp4", durationInFrames: 60, main: "差がえぐい", sub: null },
  { file: "scene06_makeup_wan21.mp4", durationInFrames: 60, main: "塗るだけじゃダメ", sub: null },
  { file: "scene07_tools_wan21.mp4", durationInFrames: 60, main: "土台を整える", sub: "目元ケア" },
  { file: "scene08_eyeclose_wan21.mp4", durationInFrames: 60, main: "まつ毛だけで別人", sub: null },
  { file: "scene09_after_wan21.mp4", durationInFrames: 90, main: "雰囲気変わった", sub: null },
  { file: "scene10_cta_wan21.mp4", durationInFrames: 60, main: "キレイになっちゃう", sub: null },
];
